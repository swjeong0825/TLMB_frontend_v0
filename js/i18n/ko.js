...
(function (global) {
  ...
  global.TLCHAT_I18N.registerLocale("ko", {
      ...
      plan: {
        "title": "경기 계획",
        "back": "← 리그로 돌아가기",
        "intro": "경기 계획을 이 브라우저에 저장한 후 업로드하여 리그와 공유하세요. 수정 후에는 다시 업로드해야 합니다. 로컬 계획을 삭제해도 서버에서는 삭제되지 않습니다.",
        "editor": "경기 계획하기",
        ...
        "upload": "경기 업로드 ({count})",
        "uploading": "경기 업로드 중…",
        "uploaded": "경기 계획 {count}개를 업로드했습니다. 로컬 사본은 유지됩니다. 추가 수정 후 다시 업로드하세요.",
        "uploadConfigError": "리그 또는 백엔드 주소가 없습니다. 로컬 경기 계획은 유지됩니다.",
        "uploadLeagueMissing": "서버에서 이 리그를 찾을 수 없습니다. 로컬 경기 계획은 유지됩니다.",
        "uploadRejected": "서버에서 경기 계획을 거부했습니다. 선수 이름을 확인하고 다시 시도하세요. 로컬 계획은 유지됩니다.",
        "uploadFailed": "서버에서 업로드를 처리하지 못했습니다. 다시 시도하세요. 로컬 경기 계획은 유지됩니다.",
        "uploadUnconfirmed": "업로드 완료를 확인할 수 없습니다. 연결 상태를 확인하고 다시 시도하세요. 안전하게 재시도할 수 있으며 로컬 계획은 유지됩니다.",
      ...
      chat: {
        ...
        plannedStubHint: "점수를 입력할 수 있지만 계획한 경기의 결과 기록은 아직 지원하지 않습니다. 점수는 저장되지 않습니다.",
        plannedRecordUnavailable: "계획한 경기의 결과 기록은 아직 지원하지 않습니다. 결과를 제출하거나 경기 계획을 삭제하지 않았습니다.",
