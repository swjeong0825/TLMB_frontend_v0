...
(function (global) {
  ...
  global.TLCHAT_I18N.registerLocale("ko", {
      ...
      plan: {
        "title": "경기 계획",
        "back": "← 리그로 돌아가기",
        "intro": "임시 계획은 새로고침, 페이지 이동, 언어 변경 시 사라집니다. 계속 보관하고 공유하려면 저장 버튼을 누르세요.",
        "editor": "경기 계획하기",
        ...
        "drafts": "임시 계획",
        "savedPlans": "저장된 계획",
        "editingDraft": "임시 계획 수정",
        "editingSaved": "저장된 계획 수정",
        "refresh": "새로고침",
        "loadPrompt": "저장된 계획을 불러오려면 새로고침하세요.",
        "delete": "삭제",
        "deleting": "계획 삭제 중…",
        "deleted": "저장된 계획을 삭제했습니다.",
        "deleteUnavailable": "이 백엔드는 삭제 API를 제공하지 않습니다. 백엔드 주소나 배포 상태를 확인하세요.",
        "deleteConfigError": "리그 또는 백엔드 주소가 없습니다. 삭제 요청을 보내지 않았습니다.",
        "deleteLeagueMissing": "리그를 찾을 수 없습니다.",
        "deletePlanMissing": "이 계획은 더 이상 대기 중이 아닙니다. 다른 곳에서 삭제되었거나 경기 결과가 기록되었을 수 있습니다.",
        "deleteRejected": "리그 또는 계획 ID가 유효하지 않습니다. 저장된 계획을 새로고침한 후 다시 시도하세요.",
        "deleteRateLimited": "요청이 너무 많습니다. 잠시 후 다시 시도하세요.",
        "deleteFailed": "계획을 삭제하지 못했습니다. 다시 시도하세요.",
        ...
        "remove": "삭제",
        "empty": "임시 계획이 없습니다.",
        "emptySaved": "저장된 계획이 없습니다.",
        "saved": "임시 계획을 추가했습니다.",
        "updated": "임시 계획을 수정했습니다.",
        "savedUpdated": "저장된 계획을 수정했습니다.",
        "removed": "임시 계획을 삭제했습니다.",
        "uploaded": "계획 {count}개를 저장했습니다. 확인된 임시 계획을 저장된 계획으로 옮겼습니다.",
        "uploadConfigError": "리그 또는 백엔드 주소가 없습니다. 변경 내용은 이 페이지에 남아 있습니다.",
        "uploadLeagueMissing": "리그를 찾을 수 없습니다. 변경 내용은 이 페이지에 남아 있습니다.",
        "uploadRejected": "서버에서 계획을 거부했습니다. 이름을 확인하고 다시 시도하세요. 변경 내용은 이 페이지에 남아 있습니다.",
        "uploadConflict": "저장된 계획과 변경 내용이 충돌합니다. 새로고침 후 다시 시도하세요. 변경 내용은 이 페이지에 남아 있습니다.",
        "uploadFailed": "서버에 계획을 저장하지 못했습니다. 다시 시도하세요. 변경 내용은 이 페이지에 남아 있습니다.",
        "uploadUnconfirmed": "저장 완료를 확인할 수 없습니다. 연결 상태를 확인하고 다시 시도하세요. 변경 내용은 이 페이지에 남아 있습니다.",
        "editUnconfirmed": "저장 완료를 확인할 수 없습니다. 저장된 계획을 새로고침한 후 다시 시도하세요.",
        ...
        "invalidUpload": "저장할 유효한 임시 계획이 없습니다. 임시 계획 목록을 확인하세요.",
        "planMissing": "목록에서 이 계획을 찾을 수 없습니다. 새로고침 후 다시 시도하세요.",
        "requestBusy": "진행 중인 요청이 끝날 때까지 기다려 주세요.",
      ...
      errors: {
        ...
        duplicateSinglesMatchToday:
          "오늘은 이미 이 두 선수의 단식 경기가 기록되어 있어요. 점수만 바꾸려면 기존 결과를 수정하고, 다른 리그 날짜에 다시 기록하세요.",
        duplicateMatch:
          "이 리그는 페어 쌍당 경기를 한 번만 허용하며, 해당 두 페어의 경기가 리그에 이미 있습니다.",
        duplicateSinglesMatch:
          "이 리그는 선수 쌍당 단식 경기를 한 번만 허용하며, 해당 두 선수의 경기가 리그에 이미 있습니다.",
        invalidLeagueRules:
      ...
      chat: {
        ...
        fieldSinglesPlayer1: "선수 1 닉네임",
        fieldSinglesPlayer2: "선수 2 닉네임",
        fieldPair1Score: "페어 1 점수",
        fieldPair2Score: "페어 2 점수",
        fieldSinglesPlayer1Score: "선수 1 점수",
        fieldSinglesPlayer2Score: "선수 2 점수",
        formScoresHeading: "점수",
        formScorePair1: "페어 1",
        formScorePair2: "페어 2",
        formScoreSinglesPlayer1: "선수 1",
        formScoreSinglesPlayer2: "선수 2",
        fieldMethod: "메서드",
        fieldUrl: "URL",
        ...
        standingsFormulaLabel: "통계 수식",
        standingsFormulaApply: "수식 적용",
        standingsFormulaReset: "초기화",
        standingsFormulaHelp: "+, -, *, /와 괄호를 사용할 수 있습니다. 공백과 영문 대소문자는 구분하지 않습니다. 값이 높을수록 순위가 높습니다.",
        standingsFormulaStats: "사용 가능한 통계",
        standingsFormulaActive: "사용자 지표로 순위를 표시합니다.",
        standingsFormulaDefault: "리그의 기본 순위를 표시합니다.",
        standingsFormulaError: "수식에 문제가 있습니다.",
        standingsUserMetric: "사용자 지표",
        ...
        standingsRankByTitle: "순위 기준",
        standingsPairOption: "페어",
        standingsPlayerOption: "플레이어",
        standingsChooseScope: "경기 형식을 선택하세요",
        standingsScopeLabel: "형식",
        standingsScopePickPlayerFirst:
          "단식 또는 통합 결과를 비교하려면 플레이어 순위를 선택하세요.",
        standingsPairDoublesOnly: "페어 순위는 복식만 지원합니다.",
        scopeDoubles: "복식",
        scopeSingles: "단식",
        scopeBoth: "통합",
        ...
        historyScopeLabel: "형식",
        historyChooseScope: "경기 기록 형식 선택",
        historyPlayerLabel: "선수",
        historyPlayerPlaceholder: "닉네임",
        historyPlayerSearch: "검색",
        historyAllPlayers: "전체 선수",
        historyFetchFailed: "경기 기록을 불러오지 못했습니다. 다시 시도하세요.",
        ...
        singlesMatchDeleted: "단식 경기가 삭제되었습니다.",
        ...
        formP1: "선수1",
        formP2: "선수2",
        matchFormatChooserLabel: "경기 형식 선택",
        matchFormatDoubles: "복식",
        matchFormatSingles: "단식",
        ...
        recordSourceTitle: "예정된 경기?",
        recordPlannedChoice: "예",
        recordManualChoice: "아니요",
        plannedTitle: "계획한 경기",
        plannedRefresh: "새로고침",
        plannedSearchLabel: "선수 닉네임으로 검색",
        plannedSearchPlaceholder: "닉네임을 입력하세요…",
        plannedNoMatches: "이 닉네임과 일치하는 경기 계획이 없습니다.",
        plannedLoading: "계획한 경기를 불러오는 중…",
        plannedEmpty: "업로드된 경기 계획이 없습니다.",
        plannedLoadFailed: "경기 계획을 불러오지 못했습니다. 새로고침으로 다시 시도하세요.",
        plannedLeagueMissing: "리그를 찾을 수 없습니다. 리그 링크를 확인하고 다시 시도하세요.",
        plannedInvalidRows: "일부 경기 계획을 읽을 수 없습니다({count}개). 서버의 계획은 변경되지 않았습니다.",
        plannedSideScore: "{side}팀 점수",
        plannedRecordButton: "결과 기록",
        plannedScoreRequired: "양쪽 점수를 모두 선택하세요.",
        plannedRecordHint: "점수를 제출하면 결과가 기록됩니다.",
        plannedBackendUnavailable: "서버가 계획 경기 기록을 아직 지원하지 않거나 API 정보를 확인할 수 없습니다. 결과를 보내지 않았습니다. 서버 업데이트 후 다시 시도하세요.",
        plannedRecording: "기록 중…",
        plannedRetry: "결과 다시 제출",
        plannedRecorded: "결과를 기록했습니다.",
        plannedRecordedButton: "기록 완료",
        plannedMissing: "더 이상 대기 중인 계획이 아닙니다. 다시 기록하기 전에 경기 내역을 확인하세요.",
        plannedMismatch: "저장된 팀이 변경되었습니다. 새 대진을 확인하고 점수를 다시 입력하세요.",
        plannedInvalidMatch: "계획이 변경되었거나 형식이 잘못되었습니다. 새로고침 후 확인하세요.",
        plannedInvalidNickname: "계획의 닉네임이 잘못되었습니다. 경기 계획에서 먼저 수정하세요.",
        plannedRepeatedPlayer: "같은 선수가 중복되었습니다. 계획을 먼저 수정하세요.",
        plannedRosterRequired: "경기를 기록하려면 다음 선수를 먼저 등록하세요:",
        plannedRuleConflict: "리그의 선수 또는 페어 규칙에 맞지 않습니다.",
        plannedRematchConflict: "리그의 재경기 규칙에 따라 기록할 수 없습니다. 경기 내역을 확인하세요.",
        plannedRateLimited: "요청이 너무 많습니다. 1분 후 다시 시도하세요.",
        plannedRejected: "결과가 거부되었습니다. 계획과 점수를 확인한 후 다시 시도하세요.",
        plannedUnconfirmed: "기록 여부를 확인하지 못했습니다. 새로 불러온 계획과 경기 내역을 확인한 후 다시 시도하세요. 이 계획을 다시 업로드하지 마세요.",
        plannedResultsRefreshFailed: "결과 데이터를 새로 불러오지 못했습니다. 기록 여부가 불확실한 결과를 다시 제출하기 전에 새로고침하세요.",
        leagueActionsLabel: "리그 메뉴",
        leagueActionRecordMatch: "경기 기록",
        leagueActionStandings: "순위",
        leagueActionMatchHistory: "경기 내역",
        quickActionRecordMatchTitle: "경기 결과 기록",
        quickActionRecordMatchDesc: "단식 또는 복식 점수를 기록합니다",
        ...
        singlesMatchRecorded: "단식 경기가 기록되었습니다.",
        matchScoreUpdated: "경기 점수가 수정되었습니다.",
        singlesMatchScoreUpdated: "단식 경기 점수가 수정되었습니다.",
        sameSinglesPlayerError:
          "단식 경기는 서로 다른 두 선수를 선택해 주세요.",
        ...
        singlesMatchAlreadyExistsToday:
          "오늘은 해당 두 선수의 단식 경기가 이미 있습니다. 기록되지 않았습니다.",
        singlesMatchAlreadyExistsInLeague:
          "이 리그에는 해당 두 선수의 단식 경기가 이미 있습니다. 기록되지 않았습니다.",
        singlesMatchAlreadyExists:
          "단식 경기가 이미 있습니다. 기록되지 않았습니다.",
