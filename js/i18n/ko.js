...
(function (global) {
  ...
  global.TLCHAT_I18N.registerLocale("ko", {
      ...
      plan: {
        "title": "경기 계획",
        "back": "← 리그로 돌아가기",
        "intro": "임시 계획은 새로고침, 페이지 이동, 언어 변경 시 사라집니다. 계속 보관하고 공유하려면 업로드하세요.",
        "editor": "경기 계획하기",
        ...
        "upload": "업로드 ({count})",
        "uploading": "업로드 중…",
        "uploaded": "계획 {count}개를 업로드했습니다. 확인된 임시 계획을 저장된 계획으로 옮겼습니다.",
        ...
        "invalidUpload": "업로드할 유효한 임시 계획이 없습니다. 임시 계획 목록을 확인하세요.",
