...
(function (global) {
  ...
  global.TLCHAT_I18N.registerLocale("en", {
      ...
      plan: {
        "title": "Plan Match",
        "back": "← Back to league",
        "intro": "Save plans in this browser, then upload them to share with your league. Local edits need another upload; removing a local plan does not delete it from the server.",
        "editor": "Plan a match",
        "chooseFormat": "Choose singles or doubles to start planning.",
        "singles": "Singles",
        "doubles": "Doubles",
        "savedPlans": "Local plans",
        "save": "Save",
        ...
        "uploading": "Uploading matches…",
        "uploaded": "Planned matches uploaded: {count}. Local copies are kept; upload again after further edits.",
        "uploadConfigError": "The league or backend address is missing. Your local plans are kept.",
        "uploadLeagueMissing": "This league could not be found on the server. Your local plans are kept.",
        "uploadRejected": "The server rejected these plans. Check the player names and try again. Your local plans are kept.",
        "uploadFailed": "The server could not accept the upload. Please try again. Your local plans are kept.",
        "uploadUnconfirmed": "The upload could not be confirmed. Check your connection and try again. Retrying is safe; your local plans are kept.",
      ...
      chat: {
        ...
        plannedStubHint: "You can enter scores here, but recording planned matches is not available yet. Scores are not saved.",
        plannedRecordUnavailable: "Recording planned matches is not available yet. No result was submitted and the plan has not been removed.",
