  ...
  var STRINGS = {
    en: {
      ...
      createLeague: {
        ...
        labelRequireEligiblePlayers: "Eligible-players allowlist",
        requireEligiblePlayersCheckboxLabel:
          "Require allowlist — only nicknames added below can play in this league",
        optionRequireEligiblePlayersFalse: "Off — anyone can be added on first match (default)",
        optionRequireEligiblePlayersTrue: "On — allowlist required",
        requireEligiblePlayersHint:
          "When on, the bot rejects match submissions that include a nickname not on your allowlist.",
        eligiblePlayersChipsPlaceholder:
          "Type a nickname and press Enter, Space, or comma to add a chip",
        eligiblePlayersChipsAria: "Eligible-players allowlist",
        eligiblePlayersChipsHint:
          "Press Enter, Space, or comma to add a chip. Backspace at the start removes the last chip. Click \u00D7 on a chip to remove it.",
        eligiblePlayersChipRemoveAria: "Remove {name} from the allowlist",
        eligiblePlayersRequiredError:
        ...
        help: {
          ...
          requireEligiblePlayersAria: "Help: eligible-players allowlist",
          requireEligiblePlayersTitle: "Eligible-players allowlist",
          requireEligiblePlayersBody:
      ...
      errors: {
        ...
        ineligiblePlayer:
          "One or more players are not on this league’s eligible-players list. Ask the host to add them before recording this match.",
      },
      chat: {
        panelStandings: "Standings",
        panelMatchHistory: "Match history",
        panelRoster: "Roster",
        panelEligiblePlayers: "Eligible players",
        ...
        fieldMethod: "Method",
        fieldUrl: "URL",
        fieldEligibleNicknames: "Eligible nicknames",
        fieldEligibleNickname: "Eligible nickname",
        emDash: "—",
        ...
        intentGetEligiblePlayersDesc: "Show the eligible-players allowlist.",
        intentGetEligiblePlayersEx1: "show me the eligible players",
        intentGetEligiblePlayersEx2: "who can join this league?",
        intentAddEligiblePlayersDesc: "Add nicknames to the eligible list.",
        intentAddEligiblePlayersEx1: "add Alex and Daniel to the eligible players",
        intentAddEligiblePlayersEx2: "make Jason eligible to play",
        intentRemoveEligiblePlayerDesc: "Remove one nickname from the eligible list.",
        intentRemoveEligiblePlayerEx1: "remove Michael from the eligible players",
        intentRemoveEligiblePlayerEx2: "drop Ryan from the allowlist",
        ...
        eligiblePanelTitle: "Eligible players",
        eligiblePanelEmpty: "No eligible players defined yet.",
        eligiblePanelLoading: "Loading eligible players…",
        eligiblePanelError: "Could not load eligible players.",
        eligibleAddPlaceholder: "e.g. alice, bob, charlie",
        eligibleAddButton: "Add",
        eligibleAddingButton: "Adding…",
        eligibleAlreadyExists: "One or more nicknames are already in the list.",
        eligibleRemoveAria: "Remove",
        eligibleRemovingAria: "Removing…",
        eligibleAddSuccess: "Added to eligible list.",
        eligibleRemoveSuccess: "Removed from eligible list.",
        ineligibleHeadline:
          "{names} are not in this league's eligible-players list. Use '{atHint}' in chat to search for the player.",
        ineligibleAddButton: "+ Add to eligible players",
      },
    },
    ko: {
      meta: {
      ...
      createLeague: {
        ...
        labelRequireEligiblePlayers: "참가 허용 목록",
        requireEligiblePlayersCheckboxLabel:
          "허용 목록 사용 — 아래에 추가한 닉네임만 이 리그에서 경기할 수 있어요",
        optionRequireEligiblePlayersFalse: "끔 — 첫 경기에 나타나면 자동 등록(기본)",
        optionRequireEligiblePlayersTrue: "켬 — 허용 목록 필수",
        requireEligiblePlayersHint:
          "켜면 허용 목록에 없는 닉네임이 포함된 경기 제출이 거부됩니다.",
        eligiblePlayersChipsPlaceholder:
          "닉네임을 입력하고 Enter, Space, 또는 쉼표를 누르면 칩으로 추가돼요",
        eligiblePlayersChipsAria: "참가 허용 목록 입력",
        eligiblePlayersChipsHint:
          "Enter, Space, 쉼표로 칩을 추가하세요. 입력창이 비어 있을 때 백스페이스를 누르면 마지막 칩이 사라져요. 칩의 \u00D7를 클릭하면 개별 삭제됩니다.",
        eligiblePlayersChipRemoveAria: "{name}을(를) 허용 목록에서 제거",
        eligiblePlayersRequiredError:
        ...
        help: {
          ...
          requireEligiblePlayersAria: "도움말: 참가 허용 목록",
          requireEligiblePlayersTitle: "참가 허용 목록",
          requireEligiblePlayersBody:
      ...
      errors: {
        ...
        ineligiblePlayer:
          "한 명 이상의 플레이어가 이 리그의 참가 허용 목록에 없습니다. 경기를 기록하기 전에 주최자에게 추가를 요청하세요.",
      },
      chat: {
        panelStandings: "순위",
        panelMatchHistory: "경기 기록",
        panelRoster: "명단",
        panelEligiblePlayers: "참가 허용 목록",
        panelHelp: "지원 명령",
        panelDetails: "세부 정보",
        ...
        fieldMethod: "메서드",
        fieldUrl: "URL",
        fieldEligibleNicknames: "허용 닉네임 목록",
        fieldEligibleNickname: "허용 닉네임",
        emDash: "—",
        ...
        intentGetEligiblePlayersDesc: "포함 허용 목록을 보여줍니다.",
        intentGetEligiblePlayersEx1: "허용된 플레이어 목록 보여줘",
        intentGetEligiblePlayersEx2: "이 리그에 참가할 수 있는 사람은?",
        intentAddEligiblePlayersDesc: "닉네임을 허용 목록에 추가합니다.",
        intentAddEligiblePlayersEx1: "Alex와 Daniel을 허용 목록에 추가해줘",
        intentAddEligiblePlayersEx2: "Jason을 참가 허용해줘",
        intentRemoveEligiblePlayerDesc: "허용 목록에서 닉네임 하나를 제거합니다.",
        intentRemoveEligiblePlayerEx1: "Michael을 허용 목록에서 제거해줘",
        intentRemoveEligiblePlayerEx2: "Ryan을 허용 목록에서 빠줘",
        ...
        eligiblePanelTitle: "참가 허용 목록",
        eligiblePanelEmpty: "아직 허용된 플레이어가 없습니다.",
        eligiblePanelLoading: "허용 목록 불러오는 중…",
        eligiblePanelError: "허용 목록을 불러올 수 없습니다.",
        eligibleAddPlaceholder: "예: alice, bob, charlie",
        eligibleAddButton: "추가",
        eligibleAddingButton: "추가 중…",
        eligibleAlreadyExists: "이미 목록에 있는 닉네임이 포함되어 있습니다.",
        eligibleRemoveAria: "제거",
        eligibleRemovingAria: "제거 중…",
        eligibleAddSuccess: "허용 목록에 추가되었습니다.",
        eligibleRemoveSuccess: "허용 목록에서 제거되었습니다.",
        ineligibleHeadline:
          "{names}은(는) 이 리그의 참가 허용 목록에 없습니다. 경기를 기록하기 전에 주최자에게 추가를 요청하세요. 채팅에서 '{atHint}'를 입력하면 플레이어를 찾을 수 있습니다.",
        ineligibleAddButton: "+ 허용 목록에 추가",
      },
    },
  };
