  ...
  var STRINGS = {
    en: {
      ...
      createLeague: {
        ...
        metricMatchDiff: "Match differential (W − L)",
        metricGamesWon: "Games won",
        metricGamesLost: "Games lost (lower is better)",
        metricGamesDiff: "Game differential",
        metricWinPct: "Win percentage",
      ...
      chat: {
        ...
        helpIntro: "Here's what I can help you with. Try one of the example phrases below.",
        ...
        intentGetStandingsByPlayerDesc:
        ...
        intentGetMatchHistoryByPlayerDesc: "View the match history for a specific player.",
        ...
        intentDeleteTeamDesc:
          "Permanently delete a team from the roster (only allowed if the team has no recorded matches).",
    ...
    ko: {
      ...
      createLeague: {
        ...
        metricNone: "(없음)",
        metricMatchesWon: "승수",
        metricMatchDiff: "승패 차(승 − 패)",
        metricGamesWon: "획득 게임 수",
        metricGamesLost: "잃은 게임 수(낮을수록 좋음)",
        metricGamesDiff: "게임 득실차",
        metricWinPct: "승률",
        submit: "리그 만들기",
      ...
      chat: {
        ...
        panelHelp: "지원 명령",
        panelDetails: "세부 정보",
        helpIntro: "이렇게 도와드릴 수 있어요. 아래 예시 문구 중 하나를 시도해 보세요.",
        ...
        intentGetMatchHistoryByPlayerDesc: "특정 플레이어의 경기 기록을 봅니다.",
        ...
        intentSubmitMatchDesc:
          "복식 경기 결과를 기록합니다. 선수와 점수를 같이 입력해도 되고, 그냥 \"경기 기록\"이라고만 해도 빈 양식이 열립니다. 새 플레이어는 자동 등록됩니다.",
        ...
        intentEditScoreDesc:
          "선수 닉네임 1\u20134명을 언급해 경기를 찾고, 그 중 하나를 골라 양식에서 점수를 수정합니다. 새 점수는 채팅에 적지 말고 양식에서 입력하세요.",
        ...
        intentDeleteTeamDesc: "명단에서 팀을 영구 삭제합니다 (해당 팀의 경기 기록이 없을 때만 가능).",
